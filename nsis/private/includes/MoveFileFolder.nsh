!ifndef __INCLUDE_MOVEFILEFOLDER
!define __INCLUDE_MOVEFILEFOLDER
...
; Created: June 2007
; Source: https://nsis.sourceforge.io/MoveFileFolder
;%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
===============
veFolder macro's ${Locate} callback functions
===============
